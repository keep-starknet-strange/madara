...
- [App Chain Template]((https://github.com/keep-starknet-strange/madara-app-chain-template)): A ready to use template that allows you to easily start an app chain.
