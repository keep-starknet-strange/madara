...
export default {
  ...
  /**
   * Lookup18: frame_system::EventRecord<madara_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  PalletStarknetEvent: {
    _enum: {
      ...
      StarknetEvent: 'MpStarknetTransactionTypesEvent'
    }
  },
  /**
   * Lookup42: mp_starknet::transaction::types::Event
   **/
  MpStarknetTransactionTypesEvent: {
    _alias: {
      keys_: 'keys'
    },
    keys_: 'Vec<H256>',
  ...
  /**
   * Lookup57: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup83: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup89: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  MpStarknetTransactionTypesTransaction: {
    ...
    hash_: 'H256',
    signature: 'Vec<H256>',
    events: 'Vec<MpStarknetTransactionTypesEvent>',
    senderAddress: '[u8;32]',
    nonce: 'U256',
  ...
  MpStarknetExecutionContractClassWrapper: {
    program: 'Bytes',
    entryPointsByType: 'BTreeMap<MpStarknetExecutionEntryPointTypeWrapper, Vec<MpStarknetExecutionEntryPointWrapper>>'
  },
  /**
   * Lookup126: mp_starknet::execution::EntryPointWrapper
   **/
  MpStarknetExecutionEntryPointWrapper: {
    entrypointSelector: 'H256',
    entrypointOffset: 'U256'
  },
  /**
   * Lookup130: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup133: mp_starknet::starknet_block::block::Block
   **/
  MpStarknetStarknetBlockBlock: {
    header: 'MpStarknetStarknetBlockHeader'
  },
  /**
   * Lookup134: mp_starknet::starknet_block::header::Header
   **/
  MpStarknetStarknetBlockHeader: {
  ...
  /**
   * Lookup138: pallet_starknet::pallet::Error<T>
   **/
  PalletStarknetError: {
    _enum: ['AccountNotDeployed', 'TransactionExecutionFailed', 'ClassHashAlreadyDeclared', 'ContractClassHashUnknown', 'ContractClassAlreadyAssociated', 'ContractClassMustBeSpecified', 'AccountAlreadyDeployed', 'ContractAddressAlreadyAssociated', 'InvalidContractClass', 'ClassHashMustBeSpecified', 'TooManyPendingTransactions', 'InvalidCurrentBlock', 'StateReaderError']
  },
  /**
   * Lookup141: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup142: sp_core::sr25519::Signature
   **/
  SpCoreSr25519Signature: '[u8;64]',
  /**
   * Lookup143: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup146: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup147: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup148: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup149: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup152: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup153: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup154: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup155: madara_runtime::Runtime
   **/
