...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    starknet: {
       ...
       **/
      contractClasses: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<MpStarknetExecutionContractClassWrapper>, [U8aFixed]> & QueryableStorageEntry<ApiType, [U8aFixed]>;
      /**
       * Mapping from Starknet contract address to the contract's class hash.
       **/
      contractClassHashes: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<U8aFixed>, [U8aFixed]> & QueryableStorageEntry<ApiType, [U8aFixed]>;
      /**
       * The current Starknet block.
       **/
      currentBlock: AugmentedQuery<ApiType, () => Observable<Option<MpStarknetStarknetBlockBlock>>, []> & QueryableStorageEntry<ApiType, []>;
      lastKnownEthBlock: AugmentedQuery<ApiType, () => Observable<Option<u64>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Mapping from Starknet contract address to its nonce.
       **/
      nonces: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<U256>, [U8aFixed]> & QueryableStorageEntry<ApiType, [U8aFixed]>;
      /**
       * The Starknet pallet storage items.
       * STORAGE
       * Current building block's transactions.
       **/
      pending: AugmentedQuery<ApiType, () => Observable<Vec<MpStarknetTransactionTypesTransaction>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Mapping from Starknet contract storage key to its value.
       **/
      storageView: AugmentedQuery<ApiType, (arg: ITuple<[U8aFixed, H256]> | [U8aFixed | string | Uint8Array, H256 | string | Uint8Array]) => Observable<U256>, [ITuple<[U8aFixed, H256]>]> & QueryableStorageEntry<ApiType, [ITuple<[U8aFixed, H256]>]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
