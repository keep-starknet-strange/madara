...
const STARKNET_VALIDIUM: &str = include_str!("../contracts/build/StarknetValidium.sol/Starknet.json");
const UNSAFE_PROXY: &str = include_str!("../contracts/build/UnsafeProxy.sol/UnsafeProxy.json");
