...
//     BlockId, CallType, EntryPointType, ExecuteInvocation, FunctionInvocation,
// InvokeTransactionTrace, StarknetError,     TransactionTrace, TransactionTraceWithHash,
// };
...
//     ARGENT_ACCOUNT_CLASS_HASH_CAIRO_0, ARGENT_CONTRACT_ADDRESS, FEE_TOKEN_ADDRESS,
// SIGNER_PRIVATE, };
...
// #[rstest]
// #[tokio::test]
// async fn fail_non_existing_transaction(madara: &ThreadSafeMadaraClient) -> Result<(),
...
// // #[rstest]
// // #[tokio::test]
// // async fn works_with_correct_transaction(madara: &ThreadSafeMadaraClient) -> Result<(),
// anyhow::Error> { //     let rpc = madara.get_starknet_client().await;

// //     // Copy-pasted from add_invoke_transaction::work_with_storage_change and
// //     // ::work_for_one_invoke_tx
// //     let funding_account = build_single_owner_account(&rpc, SIGNER_PRIVATE,
// ARGENT_CONTRACT_ADDRESS, true); //     let recipient_account =
...
// recipient_account, //                 FieldElement::ONE,
// //                 None,
// //             ))])
// //             .await?;
...
// //     // included in block
// //     let included_tx = rpc.get_transaction_by_block_id_and_index(BlockId::Number(block_number),
// 0).await?; //     let included_tx_hash = included_tx.transaction_hash();
...
// //                 })
// //             } if *contract_address ==
// FieldElement::from_hex_be(ARGENT_CONTRACT_ADDRESS).unwrap() //                 && *class_hash ==
// FieldElement::from_hex_be(ARGENT_ACCOUNT_CLASS_HASH_CAIRO_0).unwrap() //                 &&
// *entry_point_type == EntryPointType::External //                 // && *call_type ==
// CallType::Call //                 // && *entry_point_selector == execute_selector
