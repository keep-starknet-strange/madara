...
exports.expectSubstrateEvents =
  exports.expectSubstrateEvent =
  exports.expectOk =
    void 0;
...
async function expectOk(call) {
  ...
  if (Array.isArray(block.result)) {
    ...
    (0, chai_1.expect)(block.result.successful, block.result.error?.name).to.be
      .true;
  }
  return block;
}
