...
exports.extractPreimageDeposit =
  exports.getBlockArray =
  exports.fetchHistoricBlockNum =
  exports.getBlockTime =
  exports.jumpBlocks =
  exports.createAndFinalizeBlock =
    void 0;
...
const getBlockTime = (signedBlock) =>
...
const fetchHistoricBlockNum = async (api, blockNumber, targetTime) => {
  ...
  return (0, exports.fetchHistoricBlockNum)(
    api,
    blockNumber - Math.ceil((time - targetTime) / 30000),
    targetTime,
  );
};
...
const getBlockArray = async (api, timePeriod, limiter) => {
  ...
  const firstBlockNumber = await limiter.wrap(exports.fetchHistoricBlockNum)(
    api,
    lastBlockNumber,
    firstBlockTime,
  );
