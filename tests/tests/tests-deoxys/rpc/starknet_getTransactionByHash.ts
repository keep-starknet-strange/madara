...
async function checkDifferencesInBlocks() {
    ...
    for (const tx of TRANSACTIONS) {
        const differences = await benchmarkMethod('starknet_getTransactionByHash', [tx]);
...
(async () => {
	...
	const singleCallDifferences = await benchmarkMethod('starknet_getTransactionByHash', ["0x3c28efbc632f0ece25dc30aa2c5035f9aa907e43a42103609b9aded29fde516"]);
