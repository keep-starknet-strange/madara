...
(async () => {
    await benchmarkMethod('starknet_getBlockWithTxHashes', [{ "block_number": 49 }]);
    ...
    //   "latest"
    // ]);
    await benchmarkMethod('starknet_getTransactionByHash', ["0x0070b0a4765370b0b0bf5525ae98c9e89d51525dcf93de914dd0b8e3fdb14d6e"]);
    ...
    await benchmarkMethod('starknet_getTransactionReceipt', ["0x0070b0a4765370b0b0bf5525ae98c9e89d51525dcf93de914dd0b8e3fdb14d6e"]);
  })();
