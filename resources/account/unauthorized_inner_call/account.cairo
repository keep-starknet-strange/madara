...
@storage_var
func destination() -> (destination: felt) {
}

@storage_var
func function_selector() -> (selector: felt) {
}
...
@external
func __validate__{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(contract_address, selector: felt, calldata_len: felt, calldata: felt*) {
    let (contract_address) = destination.read();
    let (_function_selector) = function_selector.read();
