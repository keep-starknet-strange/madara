...
from resources.account.braavos.migrations.library import Migrations
from resources.account.braavos.signers.library import (
    Account_public_key,
    Account_signers,
...
from resources.account.braavos.constants import (
...
namespace Account {
    ...
    func _assert_multicall_valid_inner(
        ...
        _assert_multicall_valid_inner(
            self, call_array_len - 1, call_array + AccountCallArray.SIZE
        );
        return ();
    }
    ...
    func parse_initializer_signature_aux_data(
        signature_len: felt,
        signature: felt*
    ) -> (
        actual_impl: felt,
