...
from resources.account.braavos.lib.ec import verify_point
from resources.account.braavos.lib.signature import verify_secp256r1_signature
...
namespace Signers {
    ...
    func resolve_signer_from_sig{
        syscall_ptr: felt*,
        pedersen_ptr: HashBuiltin*,
        range_check_ptr
    }(signature_len: felt, signature: felt*) -> (signer: IndexedSignerModel) {
        if (signature_len == 2) {
