...
// TODO: Implement our own randomness pallet.
...
//!
//!     #[pallet::config]
//!     pub trait Config: frame_system::Config + pallet_kaioshin_randomness::Config {}
//!
//!     #[pallet::call]
...
//!             let _random_value =
//!                 <pallet_kaioshin_randomness::Pallet<T>>::random(&b"my context"[..]);
//!             Ok(())
//!         }
//!     }
//! }
...
mod tests {
    ...
    use frame_support::traits::{ConstU32, ConstU64, OnInitialize, Randomness};
    ...
    use super::*;
    use crate as pallet_kaioshin_randomness;
    ...
    frame_support::construct_runtime!(
            ...
            UncheckedExtrinsic = UncheckedExtrinsic,
        {
            ...
            CollectiveFlip: pallet_kaioshin_randomness::{Pallet, Storage},
        }
    );
