...
use sp_runtime::traits::{
    self, AtLeast32BitUnsigned, Hash as HashT, MaybeDisplay, MaybeSerialize, MaybeSerializeDeserialize, Member,
    SimpleBitOps,
};
...
pub struct Header<Number: Copy + Into<U256> + TryFrom<U256>, Hash: HashT> {
    ...
    /// The block number.
    #[cfg_attr(feature = "std", serde(serialize_with = "serialize_number", deserialize_with = "deserialize_number"))]
    #[codec(compact)]
    pub number: Number,
