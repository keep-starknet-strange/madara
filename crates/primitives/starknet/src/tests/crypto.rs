...
//     DeclareTransaction, DeployAccountTransaction, EventWrapper, InvokeTransaction, InvokeTransactionV0, Transaction, TxType,
// };
...
//     let version = 1_u8;
//     let max_fee = Felt252Wrapper::ONE;
//     let class_hash = Felt252Wrapper::THREE;
//     let contract_address_salt = Felt252Wrapper::ZERO;
//     let nonce = Felt252Wrapper::ZERO;
//     let sender_address = Felt252Wrapper::from(19911991_u64);
//     let constructor_calldata = bounded_vec!(Felt252Wrapper::ONE, Felt252Wrapper::TWO, Felt252Wrapper::THREE);
...
//     assert_eq!(transaction_hash, expected_tx_hash);
// }
...
//     let version = 1_u8;
//     let sender_address = Felt252Wrapper::from(19911991_u128);
//     let nonce = Felt252Wrapper::ZERO;
//     let max_fee = Felt252Wrapper::ONE;
//     let class_hash = Felt252Wrapper::THREE;
//     let contract_class = ContractClass::from(ContractClassV1::default());
//     let compiled_class_hash = None;

//     assert_eq!(calculate_declare_tx_hash(sender_address, class_hash, max_fee,nonce,version, compiled_class_hash,chain_id), expected_tx_hash);
// }
...
//     let sender_address = Felt252Wrapper::from(19911991_u128);
//     let calldata = bounded_vec!(Felt252Wrapper::ONE, Felt252Wrapper::TWO, Felt252Wrapper::THREE);
//     let max_fee = Felt252Wrapper::ONE;
//     let nonce = Felt252Wrapper::ZERO;
//     let version = 1_u8;
    
//     assert_eq!(calculate_invoke_tx_hash(sender_address,calldata,max_fee,nonce, version, chain_id), expected_tx_hash);
// }
...
//             transaction_hash: Felt252Wrapper::from(6_u128),
//             signature:bounded_vec![
//                 Felt252Wrapper::from(10_u128),
//                 Felt252Wrapper::from(20_u128),
//                 Felt252Wrapper::from(30_u128),
//             ],
//             contract_address: Felt252Wrapper::ZERO,
//             nonce: Felt252Wrapper::ZERO,
//             max_fee: Felt252Wrapper::from(u128::MAX),
//             calldata: BoundedVec::default(),
//             entry_point_selector: Felt252Wrapper::default(),
//         })),
//         Transaction::Invoke(InvokeTransaction::V0(InvokeTransactionV0 {
//             transaction_hash: Felt252Wrapper::from(28_u128),
//             signature:bounded_vec![Felt252Wrapper::from(40_u128)],
//             contract_address: Felt252Wrapper::try_from(&[1; 32]).unwrap(),
//             nonce: Felt252Wrapper::ZERO,
//             max_fee: Felt252Wrapper::from(u128::MAX),
//             calldata: BoundedVec::default(),
//             entry_point_selector: Felt252Wrapper::default(),
