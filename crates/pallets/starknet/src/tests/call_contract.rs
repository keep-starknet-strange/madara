...
fn given_call_contract_call_works() {
    new_test_ext::<MockRuntime>().execute_with(|| {
        ...
        let expected_erc20_address =
            ContractAddress(PatriciaKey(StarkFelt::try_from("00dc58c1280862c95964106ef9eba5d9ed8c0c16d05883093e4540f22b829dff").unwrap()));
       ...
       // Call symbol
        let symbol_selector =
            EntryPointSelector(StarkFelt::try_from("0x0216b05c387bab9ac31918a3e61672f4618601f3c598a2f3f2710f37053e1ea4").unwrap());
        ...
        // Call name
        let name_selector =
            EntryPointSelector(StarkFelt::try_from("0x0361458367e696363fbcc70777d07ebbd2394e89fd0adcaf147faccd1d294d60").unwrap());
        ...
        let decimals_selector =
            EntryPointSelector(StarkFelt::try_from("0x004c4fb1ab068f6039d5780c68dd0fa2f8742cceb3426d19667778ca7f3518a9").unwrap());
