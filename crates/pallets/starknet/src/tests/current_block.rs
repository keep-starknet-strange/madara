...
fn given_normal_conditions_when_current_block_then_returns_correct_block() {
    new_test_ext().execute_with(|| {
        ...
        let expected_current_block = StarknetHeader {
            ...
            parent_block_hash: Felt252Wrapper::from_hex_be("0x01243efd82a868d20c15c273d185467feb4addc129fb767353fa684e186d3f98")
                .unwrap(),
            transaction_count: 1,
            ...
            .unwrap(),
            event_count: 2,
            event_commitment: Felt252Wrapper::from_hex_be("0x03ebee479332edbeecca7dee501cb507c69d51e0df116d28ae84cd2671dfef02")
                .unwrap(),
