...
fn given_hardcoded_contract_run_invoke_tx_fails_sender_not_deployed() {
    new_test_ext().execute_with(|| {
        ...
        let contract_address = Felt252Wrapper::from_hex_be("0x03e437FB56Bb213f5708Fcd6966502070e276c093ec271aA33433b89E21fd31f")
            .unwrap();
...
fn given_hardcoded_contract_run_invoke_tx_then_it_works() {
    new_test_ext().execute_with(|| {
        ...
        let expected_receipt = TransactionReceiptWrapper {
            transaction_hash: Felt252Wrapper::from_hex_be("0x01b8ffedfb222c609b81f301df55c640225abaa6a0715437c89f8edc21bbe5e8")
                .unwrap(),
            actual_fee: Felt252Wrapper::from(52980_u128),
            tx_type: TxType::Invoke,
            block_number: 2_u64,
            block_hash: Felt252Wrapper::from_hex_be("0x62A89580109015D0B9B899DF7A158C248654EFDEC86C600228AC90D4D1E74FA").unwrap(),
...
fn given_hardcoded_contract_run_invoke_tx_then_event_is_emitted() {
    new_test_ext().execute_with(|| {
        ...
        let emitted_event = EventWrapper {
            keys: bounded_vec![
                Felt252Wrapper::from_hex_be("0x02d4fbe4956fedf49b5892807e00e7e9eea4680becba55f9187684a69e9424fa").unwrap()
            ],
            data: bounded_vec!(
                Felt252Wrapper::from_hex_be("0x1").unwrap()
            ),
            from_address: Felt252Wrapper::from_hex_be("0x024d1e355f6b9d27a5a420c8f4b50cea9154a8e34ad30fc39d7c98d3c177d0d7")
                .unwrap(),
        };
        ...
        let expected_receipt = TransactionReceiptWrapper {
            transaction_hash: Felt252Wrapper::from_hex_be("0x0554f9443c06ce406badc7159f2c0da29eac095f8571fe1a6ce44a2076829a52").unwrap(),
...
fn given_hardcoded_contract_run_invoke_with_inner_call_in_validate_then_it_fails() {
    new_test_ext().execute_with(|| {
        ...
        StorageView::<MockRuntime>::insert(
            (transaction.sender_address, Into::<Felt252Wrapper>::into(Felt252Wrapper::try_from(&storage_key.0.0.0).unwrap())),
