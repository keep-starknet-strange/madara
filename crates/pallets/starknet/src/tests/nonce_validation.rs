...
use super::mock::no_nonce_validation_mock::new_test_ext_without_nonce_validation;
use crate::tests::constants::SALT;
use crate::tests::mock::no_nonce_validation_mock::{
    basic_test_setup_without_nonce_validation, MockWithoutNonceValidationRuntime, RuntimeOrigin, Starknet,
};
...
fn given_invoke_tx_with_invalid_nonce_then_it_works() {
    new_test_ext_without_nonce_validation().execute_with(|| {
