...
use mp_transactions::{DeclareTransactionV1, InvokeTransactionV1, DeployAccountTransaction};
...
// const SEND_MESSAGE_TO_L2_SELECTOR: &str = "0x38fb0bf48fe489ae23d0a1d7f2b7195ec0b94bfeb2f408b13bfd943d8410d72";
const SEND_MESSAGE_TO_L1_SELECTOR: &str = "0x9139dbd19ca9654d773cd88f31af4c8d583beecc3362fb986dccfef5cf134f";

// Troubleshooting:
// Add println! to the necessary runtime method (e.g. print CallInfo structs or extended blockifier message)
// RUST_LOG=runtime=error RUST_BACKTRACE=1 cargo test --package pallet-starknet send_message -- --nocapture
...
fn messages_to_l1_are_stored() {
    new_test_ext::<MockRuntime>().execute_with(|| {
        ...
        let sender_address: Felt252Wrapper = get_account_address(None, AccountType::V0(AccountTypeV0Inner::NoValidate)).into();
        ...
        let contract_address: Felt252Wrapper = DeployAccountTransaction::calculate_contract_address(
            salt.into(), 
            class_hash.into(), 
            &[]
        ).into();
