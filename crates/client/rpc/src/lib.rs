...
const NO_VALIDATE_ACCOUNT_CLASS_HASHES: [&str; 2] = [
...
const PREDEPLOYED_ACCOUNTS_ADDRESSES: [&str; 4] = ["0x1", "0x2", "0x3", "0x4"];
...
const FEE_TOKEN_ADDRESS: &str = "0x49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7";
