...
use crate::{ filter_events_by_params};
...
fn filter_events_by_test_case(#[case] params: TestCase) {
	let (filtered_events, continuation_token) = filter_events_by_params(params.events.into_iter().skip(0), params.filter_address, params.filter_keys, params.max_results);
