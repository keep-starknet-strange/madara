...
use blockifier::execution::contract_class::ContractClass as BlockifierCasmClass;
use mc_db::sierra_classes_db::SierraClassesDb;
use mp_transactions::DeclareTransactionV2;
...
pub fn validate_declare_v2_transaction(
    ...
    let compiled_casm_class_hash =
        blockifier_casm_class_to_compiled_class_hash(casm_class).map_err(|e| ConsensusError::Other(Box::new(e)))?;
