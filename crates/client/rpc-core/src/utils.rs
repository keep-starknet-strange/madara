...
pub fn to_rpc_contract_class(contract_class_wrapped: BlockifierContractClass) -> Result<ContractClass> {
    match contract_class_wrapped {
        ...
        BlockifierContractClass::V1(contract_class) => Ok(ContractClass::Sierra(FlattenedSierraClass {
            sierra_program: vec![], // TODO: add sierra program
            contract_class_version: contract_class.program.compiler_version,
