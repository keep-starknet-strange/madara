...
pub fn run() -> sc_cli::Result<()> {
    ...
    match &cli.subcommand {
        ...
        Some(Subcommand::TryRuntime(cmd)) => {
            ...
            let info_provider = substrate_info(madara_runtime::SLOT_DURATION);
            ...
            runner.async_run(|config| {
                ...
                Ok((cmd.run::<Block, HostFunctionsOf<service::ExecutorDispatch>, _>(Some(info_provider)), task_manager))
            })
        }
